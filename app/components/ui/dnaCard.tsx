...
export default function CurrentDNACard({
  ...
  const silhouettePrefs =  dna.silhouette_prefs || []
  const colorPalette = dna.color_palette || []
  const fabricTypes =  dna.fabric_types || []
  const aestheticKeywords = dna.aesthetic_keywords || []
  const occasionStyle =  dna.occasion_style || ''
